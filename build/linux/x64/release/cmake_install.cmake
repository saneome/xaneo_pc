...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Runtime" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}/home/xaneodev/xaneo_pc/build/linux/x64/release/bundle/xaneo_pc_new" AND
    ...
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/home/xaneodev/xaneo_pc/build/linux/x64/release/bundle/xaneo_pc_new"
         OLD_RPATH "/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/file_selector_linux:/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/screen_retriever:/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/url_launcher_linux:/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/window_manager:/home/xaneodev/xaneo_pc/linux/flutter/ephemeral:"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Runtime" OR NOT CMAKE_INSTALL_COMPONENT)
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/home/xaneodev/xaneo_pc/build/linux/x64/release/bundle/lib/libfile_selector_linux_plugin.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
  ...
  file(INSTALL DESTINATION "/home/xaneodev/xaneo_pc/build/linux/x64/release/bundle/lib" TYPE FILE FILES "/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/file_selector_linux/libfile_selector_linux_plugin.so")
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Runtime" OR NOT CMAKE_INSTALL_COMPONENT)
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/home/xaneodev/xaneo_pc/build/linux/x64/release/bundle/lib/liburl_launcher_linux_plugin.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
  ...
  file(INSTALL DESTINATION "/home/xaneodev/xaneo_pc/build/linux/x64/release/bundle/lib" TYPE FILE FILES "/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/url_launcher_linux/liburl_launcher_linux_plugin.so")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/file_selector_linux/cmake_install.cmake")
  include("/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/screen_retriever/cmake_install.cmake")
  include("/home/xaneodev/xaneo_pc/build/linux/x64/release/plugins/url_launcher_linux/cmake_install.cmake")
